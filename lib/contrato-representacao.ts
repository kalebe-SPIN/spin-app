...
3.2. Seguro mínimo nos 3 (três) primeiros meses — período de experiência —, de forma crescente: ${garantidoContrato}. Trata-se de GARANTIA DE VALOR MÍNIMO (não cumulativa): apurados no mês o fixo da cláusula 3.1 somado à comissão, se o resultado for INFERIOR ao seguro mínimo, prevalece o seguro mínimo; se for IGUAL OU SUPERIOR, prevalece o fixo somado à comissão. O seguro mínimo é devido integralmente mediante o cumprimento da meta de atividade do mês; não atingida a meta, é ajustado proporcionalmente ao efetivamente entregue. Após esse período não há seguro mínimo, permanecendo o fixo da cláusula 3.1 somado à comissão.
